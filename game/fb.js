...
var drawBird = function (scaleWidth, scaleHeight) {
	// Update the drawImage method to use the new width and height
	ctx.drawImage(bird, 0, birdN * 0, bird.width, 38, birdPos, birdY, scaleWidth, scaleHeight);
